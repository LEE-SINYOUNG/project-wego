...
>    |이신영| - 산 정보게시판, 모집 게시판, 후기 게시판 메인 Frontend / Backend<br/> - 비동기 무한스크롤 기능<br/> - 비동기 게시글 정렬 <br/> - 검색어 일치하는 검색결과 반환 및 비동기 무한스크롤<br/> - 목록 좋아요반영<br/> - 산상세정보페이지에 좋아요 기능추가<br/> - 프로젝트 화면 초기 디자인 Figma |
