...
>    |이신영| - 산 정보게시판, 모집 게시판, 후기 게시판 메인 Frontend / Backend<br/> - 비동기 무한스크롤 기능<br/> - 비동기 게시글 정렬 <br/> - 검색어 일치하는 검색결과 반환 및 비동기 무한스크롤<br/> - 게시글 좋아요 <br/> - 산 상세정보 좋아요 기능추가<br/> - 화면 초기 디자인 Figma |
...
## 프로젝트 기간
>   KH Final Team Project 2023.01.06 ~ 2023.05.09 (18주)
### 회의 일정
| 날짜            | 회의 내용                 |
| --------------- | ------------------------- |
